package tests {
	...
	public class Output extends Panel {
		...
		override protected function addChildren():void {
            ...
            clear = new PushButton(content, 205 + 190 - 60-10, 101 - 30, "clear", function (e:Event):void { text.text = ""; } );
            clear.width = 60
		}
        ...
        public function log(msg:String):void {
            ...
            scrollBar.setThumbPercent(text.textField.scrollV / text.textField.maxScrollV);
        }
	}
}